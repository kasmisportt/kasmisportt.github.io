...
const btnSubirMarcas =
document.getElementById("btnSubirMarcas");

window.addEventListener("scroll", () => {

    if(window.scrollY > 500){

        btnSubirMarcas.classList.add("show");

    } else {

        btnSubirMarcas.classList.remove("show");

    }

});

btnSubirMarcas.addEventListener("click", () => {
